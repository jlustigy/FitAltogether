...
In other words, any set of vertices in $J$-dimensional space that can enclose the observed data, $\vec d_i$, if any, can be the solutions for equation (\ref{eq:d_f_ast_s}), as long as all of the element in $x_{kj}$ satisfy $0<x_{kj}<1$. 
