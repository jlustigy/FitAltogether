...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Fit with $f$ or with $f^{\ast}$?}
\label{ss:degeneracy}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
One reason comes from the fact the approximation adopted in equation (\ref{eq:discretize}). This is valid only when $f_k (\vec \Omega)$ does not change significantly in the $l$-th slice. 
If this isn't the case, equation (\ref{eq:Wf}) is no longer a good discritization. 

If that condition is satisfied for $L=I$ slices, then in general cases there is a one-to-one relationship between $f^{\ast}_{ik}$ and $f_{lk}$ through $W_{il}$ as far as ${\rm rank}(W)=L(=I)$. 
